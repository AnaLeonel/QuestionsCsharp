...
class Carro : Veiculo
{
    ...
    public int QuantidadePortas { get; set; } // número de portas do carro
}
...
class Caminhao : Veiculo
{
    ...
    public decimal CapacidadeCarga { get; set; } // capacidade de carga do caminhão (em kg)
}
...
class Program
{
    static void Main()
    {
        ...
        Console.WriteLine($"Quantidade de Portas: {carro1.QuantidadePortas}"); // imprime a quantidade de portas do carro
        Console.WriteLine();
